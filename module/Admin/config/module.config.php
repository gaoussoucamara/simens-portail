...
return array(
		...
		// The following section is new and should be added to your file
				'router' => array(
						'routes' => array(
								//Pour gerer la connexion a partir de --- localhost/www-simens-sn/public
								'home' => array(
										'type' => 'Zend\Mvc\Router\Http\Literal',
										'options' => array(
												'route'    => '/',
												'defaults' => array(
														'controller' => 'Actualite\Controller\Actualite', //Rediriger vers atualite pour la page d'accueil
														'action'     => 'actualite',
												),
										),
								),
		...
		'di' => array(
				'instance' => array(
						...
						'Zend\Authentication\Adapter\DbTable\CredentialTreatmentAdapter' => array(
								'parameters' => array(
										'tableName' => 'personne',
										'identityColumn' => 'pseudo',
										'credentialColumn' => 'mot_de_passe',
								)
						),
				),
		),
