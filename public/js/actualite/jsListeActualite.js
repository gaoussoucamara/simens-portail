...
//        });
    ...
    function depublier (id){
    	$('#depublier-'+id).w2overlay({ html: "" +
			"" +
			"<div style='border-bottom:1px solid #49afcd; height: 30px; background: #f9f9f9; width: 210px; text-align:center; padding-top: 10px; font-size: 13px; color: #49afcd; font-weight: bold;'>Confirmer la d&eacute;publication</div>" +
			"<div style='height: 50px; width: 210px; padding-top:10px; text-align:center;'>" +
			"<button class='btn' style='cursor:pointer;' onclick='popupFermer(); return false;'>Annuler</button>" +
			"<button class='btn' style='cursor:pointer;' onclick='depublication("+id+"); return false;'>D&eacute;publier</button>" +
			"</div>" +
			"" 
    	});
    }
